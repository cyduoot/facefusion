...
class Pix2PixModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.netG = networks.define_G(opt.input_nc*2, opt.output_nc, opt.ngf,
    ...
    def backward_G(self):
        ...
        # Second, G(A) = B
        self.loss_G_L1 = self.criterionL1(self.fake_B, self.real_B) * self.opt.lambda_A * 0.9
        ...
        self.loss_G_PL = self.criterionPL(self.fake_B, self.real_B) * 300
